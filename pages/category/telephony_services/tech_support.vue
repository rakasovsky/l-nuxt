  ...
  <div class="antiowerflow_container">
    ...
    <section class="lumex_team joc" id="s_cov19">
      <div class="team_left">
        <div>
          ...
          <h3 class="h_title fs24 txt3">{{ $t("tstsupp2") }}</h3>
    ...
    <section class="category_diogram category_diogram2 joc2" id="s_auto">
      <div class="diogram_left">
        <div class="cloud__block4 jt">
          <p class="label txt3"><span class="lumex">L</span>umex / Asterisk</p>
          <h3 class="h_title fs24 txt3">{{ $t("tstsupp3") }}</h3>
          <p class="fs24 txt3">{{ $t("tstsupp3_1") }}</p>
          <p class="txt3">{{ $t("tstsupp3_2") }}</p>
          <p class="txt3">{{ $t("tstsupp3_3") }}</p>
          <p class="txt3">{{ $t("tstsupp3_4") }}</p>
          <p class="txt3">{{ $t("tstsupp3_5") }}</p>
    ...
    <section class="lumex_team joc" id="s_cov19">
      <div class="team_left">
        <div>
          <p class="label txt3"><span class="lumex">L</span>umex / Asterisk</p>
          <h3 class="h_title fs24 txt3">{{ $t("tstsupp4") }}</h3>
          <p class="txt3">{{ $t("tstsupp4_1") }}</p>
          <p class="txt3">{{ $t("tstsupp4_2") }}</p>
          <ul style="margin-top: 10px" class="category-list">
            <li><span class="checkmark"></span>{{ $t("tstsupp4_3") }}</li>
            <li><span class="checkmark"></span>{{ $t("tstsupp4_4") }}</li>
            <li><span class="checkmark"></span>{{ $t("tstsupp4_5") }}</li>
            <li><span class="checkmark"></span>{{ $t("tstsupp4_6") }}</li>
            <li><span class="checkmark"></span>{{ $t("tstsupp4_7") }}</li>
            <li><span class="checkmark"></span>{{ $t("tstsupp4_8") }}</li>
            <li><span class="checkmark"></span>{{ $t("tstsupp4_9") }}</li>
            <li><span class="checkmark"></span>{{ $t("tstsupp4_10") }}</li>
          </ul>
        </div>
      </div>
      <div class="team_right cov19_skud cctv txt3">
    ...
    <section class="category_diogram category_diogram2 joc2" id="s_auto">
      <div class="diogram_left">
        <div class="cloud__block4 jt">
          <p class="label txt3"><span class="lumex">L</span>umex / Asterisk</p>
          <h3 class="h_title fs24 txt3">{{ $t("tstsupp5") }}</h3>
          <p class="txt3">{{ $t("tstsupp5_1") }}</p>
          <p class="txt3">{{ $t("tstsupp5_2") }}</p>
          <ul style="margin-top: 10px" class="category-list">
            <li><span class="checkmark"></span>{{ $t("tstsupp5_3") }}</li>
            <li><span class="checkmark"></span>{{ $t("tstsupp5_4") }}</li>
            <li><span class="checkmark"></span>{{ $t("tstsupp5_5") }}</li>
            <li><span class="checkmark"></span>{{ $t("tstsupp5_6") }}</li>
          </ul>
          <p class="txt3">{{ $t("tstsupp5_7") }}</p>
    ...
    <section class="lumex_team joc" id="s_cov19">
      <div class="team_left">
        <div>
          <p class="label txt3"><span class="lumex">L</span>umex / Asterisk</p>
          <h3 class="h_title fs24 txt3">{{ $t("tstsupp6") }}</h3>
          <p class="txt3">{{ $t("tstsupp6_1") }}</p>
          <p class="txt3">{{ $t("tstsupp6_2") }}</p>
          <p class="txt3">{{ $t("tstsupp6_3") }}</p>
          <p class="txt3">{{ $t("tstsupp6_4") }}</p>
    ...
    <section class="category_diogram category_diogram2 joc2" id="s_auto">
      <div class="diogram_left">
        <div class="cloud__block4 jt">
          <p class="label txt3"><span class="lumex">L</span>umex / Asterisk</p>
          <h3 class="h_title fs24 txt3">{{ $t("tstsupp7") }}</h3>
          <p class="txt3">{{ $t("tstsupp7_1") }}</p>
          <p class="txt3">{{ $t("tstsupp7_2") }}</p>
          <p class="txt3">{{ $t("tstsupp7_3") }}</p>
          <p class="txt3">{{ $t("tstsupp7_4") }}</p>
          <p class="txt3">{{ $t("tstsupp7_5") }}</p>
          <p class="txt3">{{ $t("tstsupp7_6") }}</p>
          <p class="txt3">{{ $t("tstsupp7_7") }}</p>
          <p class="txt3">{{ $t("tstsupp7_8") }}</p>
          <p class="txt3">{{ $t("tstsupp7_9") }}</p>
          <p class="txt3">{{ $t("tstsupp7_10") }}</p>
          <p class="txt3">{{ $t("tstsupp7_11") }}</p>
          <p class="txt3">{{ $t("tstsupp7_12") }}</p>
          <p class="txt3">{{ $t("tstsupp7_13") }}</p>
