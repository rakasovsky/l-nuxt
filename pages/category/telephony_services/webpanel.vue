  ...
  <div class="antiowerflow_container">
      ...
      <div class="category_container">
        ...
        <div class="category_text lumex__video">
          <div class="cloud__block4 sks">
            <h3 class="h_title fs42">{{ $t("tswp1") }}</h3>
            <p class="fs24">
              {{ $t("tswp1_1") }}
            </p>
            <p class="fs24">
    ...
    <section class="lumex_team joc" id="s_cov19">
      <div class="team_left">
        <div>
          ...
          <h3 class="h_title fs24 txt3">{{ $t("tswp2") }}</h3>
          <p class="txt3">{{ $t("tswp2_1") }}</p>
    ...
    <section class="category_diogram category_diogram2 joc2" id="s_auto">
      <div class="diogram_left">
        <div class="cloud__block4 jt">
          <p class="label txt3"><span class="lumex">L</span>umex / Asterisk</p>
          <h3 class="h_title fs24 txt3">{{ $t("tswp3") }}</h3>
          <p class="txt3">{{ $t("tswp3_1") }}</p>
          <p class="txt3">{{ $t("tswp3_2") }}</p>
          <p class="txt3">{{ $t("tswp3_3") }}</p>
    ...
    <section class="lumex_team joc" id="s_cov19">
      <div class="team_left">
        <div>
          <p class="label txt3"><span class="lumex">L</span>umex / Asterisk</p>
          <h3 class="h_title fs24 txt3">{{ $t("tswp4") }}</h3>
          <p class="txt3">{{ $t("tswp4_1") }}</p>
