<template>
    ...
    <section class="category_diogram category_diogram2 joc2" id="v_smart">
    ...
    <section class="lumex_team joc" id="v_ip">
        <div class="team_left">
            <div>
    ...
    <section class="category_diogram category_diogram2  cctv_hd" id="v_hd">
        <div class="diogram_left">
            <div class="cloud__block4 jt">
    ...
    <section class="lumex_team lumex_team2" id="v_service" >
        <div class="team_left">
            <div>
